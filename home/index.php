...
<!--<h3>--><?php //echo $one['artical_title']?><!--</h3>-->
<!--<hr/>-->
<?php //endforeach;?>
...
<!--        <if($one['column_id'] == $item['column_id']){-->
<!--        <h2>--><?php //echo $one['column_name']?><!--</h2>-->


        <?php if ($one['column_id'] == $item['column_id']):?>
            <h3><a href="show.php/?artical_id=<?php echo $item['artical_id'];?>"><?php echo $item['artical_title']?></a></h3>
        <?php endif;?>
